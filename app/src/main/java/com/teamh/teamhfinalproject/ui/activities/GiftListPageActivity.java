...
public class GiftListPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String object1 = objectIntent.getStringExtra("object0");


        if(objectIntent.getStringExtra("object1") != null)
        {
            String object2 = objectIntent.getStringExtra("object1");
            gifts.add(IntentToEtsy(object2));//this is the new object
        }

        if(objectIntent.getStringExtra("object2") != null)
        {
            String object3 = objectIntent.getStringExtra("object2");
            gifts.add(IntentToEtsy(object3));//this is the new object
        }

        if(objectIntent.getStringExtra("object3") != null)
        {
            String object4 = objectIntent.getStringExtra("object3");
            gifts.add(IntentToEtsy(object4));//this is the new object
        }
